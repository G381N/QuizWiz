...
import { Home, Bell, User, LayoutGrid } from "lucide-react"
...
export function BottomNav() {
    ...
    return (
        <div className="md:hidden fixed bottom-0 left-0 right-0 h-20 bg-secondary/80 backdrop-blur-sm border-t border-border">
